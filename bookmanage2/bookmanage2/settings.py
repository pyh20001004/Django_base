"""
Django settings for bookmanage2 project.
...
MIDDLEWARE = [
    ...
    # 注册自定义的中间件
    'book.views.TestMiddleware_1',
    'book.views.TestMiddleware_2',
]

ROOT_URLCONF = 'bookmanage2.urls'
...
WSGI_APPLICATION = 'bookmanage2.wsgi.application'
